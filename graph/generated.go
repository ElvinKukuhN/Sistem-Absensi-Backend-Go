...
type MutationResolver interface {
	SignUp(ctx context.Context, input model.SignUpRequest) (*model.User, error)
}
...
func (ec *executionContext) field_Mutation_signUp_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNSignUpRequest2SistemᚑAbsensiᚑBackendᚑGoᚋgraphᚋmodelᚐSignUpRequest(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_signUp(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖSistemᚑAbsensiᚑBackendᚑGoᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNSignUpRequest2SistemᚑAbsensiᚑBackendᚑGoᚋgraphᚋmodelᚐSignUpRequest(ctx context.Context, v any) (model.SignUpRequest, error) {
...
func (ec *executionContext) marshalNUser2SistemᚑAbsensiᚑBackendᚑGoᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖSistemᚑAbsensiᚑBackendᚑGoᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
